...
export function LeadCard({ lead, isAlumni = false }: LeadCardProps) {
  const hasSocials = lead.linkedin || lead.discord || lead.github;

  return (
    <Card className={isAlumni ? "opacity-75" : ""}>
          ...
          {hasSocials && (
            <div className="flex items-center gap-3 mt-2">
              ...
              {lead.discord && (
                ...
                >
                  <DiscordIcon className="w-4 h-4 inline mr-1" />
                  {lead.discord}
                </span>
              )}
            </div>
